...
**`gemini-3-flash-preview`** for general vision tasks. Use **`gemini-3.1-pro-preview`** for complex analysis (dense screenshots, charts with data points, multi-element UI designs).

> **Note:** For complex images (dense screenshots, charts, code, UI designs), this skill provides more accurate analysis than Claude's built-in vision. Route complex visual analysis tasks through Gemini for best results.
...
- **gemini-3.1-pro-preview**: Best quality, complex image analysis
- **gemini-3-flash-preview**: Fast, cost-effective, all features

### Gemini 2.5 Series (Stable)
- **gemini-2.5-pro**: High quality, segmentation + detection
- **gemini-2.5-flash**: Production-stable, all features
