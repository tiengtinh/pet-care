...
**`gemini-3-flash-preview`** — fast, cost-effective multimodal processing for video tasks. For budget-constrained batch jobs or production stability, `gemini-2.5-flash` remains a stable alternative.
...
- **gemini-3.1-pro-preview**: Best quality, 1M context
- **gemini-3-flash-preview**: Fast, cost-effective, 1M context

### Gemini 2.5 Series (Stable)
- **gemini-2.5-pro**: High quality, 1M-2M context
- **gemini-2.5-flash**: Balanced, 1M-2M context, production-stable
